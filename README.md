...
Tempo de curso: 2 meses e 4 dias

O objetivo deste projeto era criar uma página que carregasse uma lista de produtos capturados da API do Mercado Livre e que fosse possível adicionar estes produtos num carrinho de compras, somando o preço total. Para isso utilizamos `JavaScript`.

Depois de finalizado modifiquei o layout da página fazendo uma semi-cópia do mercado livre, treinando assim `CSS`. Também modifiquei a forma que os itens são apresentados no carrinho e mais alguns pequenos detalhes.
...
_Parte dos códigos já vinham na base do projeto_
